...
const DestinationCard = ({ title, subtitle, price, image, badge }) => (
...
export default function Home() {
  ...
  <div className="absolute left-1/2 -translate-x-1/2 top-0 -translate-y-[60%] md:-translate-y-[60%] lg:-translate-y-[80%] w-full px-6 z-30">
          <div className="mx-auto bg-white rounded-xl shadow-2xl ring-1 ring-black/5 max-w-6xl overflow-visible">
            <div className="p-4 md:p-6 lg:p-8">
              <div className="mb-4">
                <h3 className="text-xl font-semibold">¿A dónde vas?</h3>
                <div className="mt-3 flex items-center gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="trip" className="radio radio-primary" value="roundtrip" checked={trip === "roundtrip"} onChange={() => setTrip("roundtrip")} />
                    <span className="text-sm">Ida y vuelta</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="trip" className="radio" value="oneway" checked={trip === "oneway"} onChange={() => setTrip("oneway")} />
              ...
              <form className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                ...
                {/* From */}
                {/* Origen / Destino box */}
                <div className={trip === "oneway" ? "md:col-span-7 lg:col-span-7" : "md:col-span-5 lg:col-span-5"}>
                  <div className="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-lg px-3 h-14">
                ...
                {/* Dates box */}
                <div className={trip === "oneway" ? "md:col-span-3 lg:col-span-3" : "md:col-span-5 lg:col-span-5"}>
                  <div className="flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-lg px-3 h-14">
                    <div className="flex-1 flex items-center gap-2">
                      <div className="text-xs text-gray-500">Ida</div>
                      <Calendar className="h-5 w-5 text-purple-600" />
                      <input type="date" className="input input-ghost w-full" />
                    </div>
                    {trip === "roundtrip" && (
                      <>
                        <div className="h-8 w-px bg-gray-200" />
                ...
                <div className="md:col-span-2 lg:col-span-2 flex items-center gap-3">
                  <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3 h-14 w-full">
                  ...
                  <div className="w-12 h-12">
                    <button type="submit" className="w-12 h-12 bg-purple-700 hover:bg-purple-800 text-white rounded-lg flex items-center justify-center">
      ...
      <section className="container mx-auto px-6 lg:px-20 mt-10">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold">
            DESTINO PARA TI HOY EN COLOMBIA
          </h2>
